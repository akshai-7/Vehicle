    ...
    <section id="container">
        <div id="div-1">
            ...
            <a class="nav_list" href="/inspectiondetails">
                <div class="icon-name"> <i class="fa-solid fa-list"></i> </div><span class="nav_name"> Inspection
                    List</span>
            </a>
        ...
        <div id="div-2">
                            ...
                            <tbody>
                                @foreach ($vehicle as $vehicle)
                                    <tr class="table_row">
                                        ...
                                        <td style="text-align:center;" class="table_data"><img
                                                src="{{ url('images/' . $vehicle->image) }}" width="50px"
                                                height="50px" alt=""
                        ...
                        <tbody>
                            @foreach ($cabin as $cabin)
                                <tr class="table_row">
                                    ...
                                    <td style="text-align:center;" class="table_data"><img
                                            src="{{ url('images/' . $cabin->image) }}" width="50px" height="50px"
            ...
            <div>
                <a href="/summary/{{ $cabin->assign_id }}"><input type="submit" value="Summary" class="text-white"
                        style="background: #06064b" id="add"></a>
            </div>
        </div>
    </section>
    <script>
