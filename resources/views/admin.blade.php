    ...
    <div class="userContainer">
        <div class="table-data">
            <div class="order">
                <div class="head">
                    <h3>Admin Details</h3>
                    <a style="margin-right:20px;"><input type="submit" value="Add-Admin" id="add"
                            onclick="show('sam')"></a>
                </div>
                <div class="serachbar">
    ...
    <div id="sam">
        <div class="userPopUp">
            <form action="/createuser" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div id="userHeading">
                    <h5 class="" style="color:#bf0e3a;"><i class="fa-solid fa-user"></i> Create Admin</h5>
                    <a onclick="hide('sam')">
                ...
                <div class="report1">
                    <div class="report">
                        ...
                        <div class="form-group row mt-4 ">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="role" class="form-control" required value="Admin">
                                <div style="color:rgb(216, 31, 31);font-size:14px;"> @error('name')
                                        *{{ $message }}
                                    @enderror
                                </div>
